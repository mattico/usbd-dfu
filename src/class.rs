...
pub trait DFUMemIO {
    ...
    /// Similar to [`PAGE_PROGRAM_TIME_MS`](DFUMemIO::BLOCK_PROGRAM_TIME_MS), but for a page erase operation.
    const PAGE_ERASE_TIME_MS: u32;

    /// Similar to [`PAGE_PROGRAM_TIME_MS`](DFUMemIO::BLOCK_PROGRAM_TIME_MS), but for a full erase operation.
